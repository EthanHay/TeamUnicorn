...
<fieldset class="subtleSet">
    ...
    <p>
      ...
      <input type="text" name="name" id="name" class="new">
    </p>
    <p>
      <label class="label"  for="email">E-mail Address: </label>
      <input type="text" name="email" id="email" class="new">
    </p>
    <p>
      <label class="label"  for="facebook">Website/Facebook Address: </label>
      <input type="text" name="facebook" id="facebook" class="new">
    </p>
     <p>
      <label class="label"  for="phone">Phone Number: </label>
      <input type="text" name="phone" id="phone" class="new">
    </p>
    <p>
      <label class="label"  for="genre">Main Genre: </label>
      <input type="text" name="genre" id="genre" class="new">
    </p>
    <p>
      <label class="label"  for="about">About the Artist: </label>
      <input type="text" name="about" id="about" class="new">
    </p>
    <p>
