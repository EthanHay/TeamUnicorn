...
<form id="deleteForm" name="deleteForm" method="post" action="dbprocessmember.php">
  <?php
	...
	<input type='text' name='address' value='$row[address]' /> <input type='text' name='poastcode' value='$row[poastcode]' /> 
	...
	<input type='text' name='email' value='$row[email]' /><input type='text' name='suername' value='$row[username]' />
